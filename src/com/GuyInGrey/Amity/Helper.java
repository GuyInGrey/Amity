...
public class Helper
{
  ...
  public static void FillArea(Material mat, Location loc1, Location loc2)
  {
    ...
    Location l1 = new Location(w, Math.min(loc1.getX(), loc2.getX()), Math.min(loc1.getY(), loc2.getY()),
        Math.min(loc1.getZ(), loc2.getZ()));

    Location l2 = new Location(w, Math.max(loc1.getX(), loc2.getX()), Math.max(loc1.getY(), loc2.getY()),
